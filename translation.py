class Translation(object):
    START_TEXT = """hey,
Iam a Databoxtech Upload Bot! Created by @TRS01_0
Send me any DATABOXTECH URL, i can upload to telegram as File/Video
    
👻/start = Check whether the bot is alive or died
👻/help = how to use me! 
👻/about = Who am I !
"""
    ...
    FORMAT_SELECTION = """📭 𝗦𝗲𝗹𝗲𝗰𝘁 𝗔𝗻𝗱 𝗖𝗵𝗼𝘀𝗲 𝗬𝗼𝘂𝗿 𝗙𝗼𝗿𝗺𝗮𝘁👇🎞️ 𝗩𝗜𝗗𝗘𝗢 = Upload as Streamble.
...
⭕️<b>Creater :</b> @TRS01_0
⭕️<b>Language :</b> <code>Python3</code>
⭕️<b>Library :</b> <a href='https://docs.pyrogram.org/'>Pyrogram 1.0.7</a> 
⭕️<b>Source Code :</b> 👉 <a licc  / a>"""
    
    HELP_USER = """Hi am Databoxtech Uploader bot..
